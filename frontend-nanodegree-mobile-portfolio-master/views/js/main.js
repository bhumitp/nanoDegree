...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    ...
    var pizzaContLength = document.getElementsByClassName("randomPizzaContainer").length;

    //Setting this variable to save time on processing
    ...
    //This loop cuts down time for browser for having to render over and over
    for (var i = 0; i < pizzaContLength; i++) {
      pizzaContainer[i].style.width = newwidth[i];
    }
  }
...
function updatePositions() {
  ...
  //Moved this outside the loop to save time
  var scrollTop = document.body.scrollTop / 1250;

  for (var i = 0; i < items.length; i++) {
    // document.body.scrollTop is no longer supported in Chrome.
    //var scrollTop = document.documentElement.scrollTop || document.body.scrollTop;
    var phase = Math.sin((scrollTop) + (i % 5)); //Changed the variable
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  //Moved variables outside the loop and replaced query selector for faster processing
